...
urlpatterns = [
    ...
    # ─── Receipt PDFs (from Payments) ────────────────────
    path('receipts/<int:payment_pk>/print/', views.ReceiptPDFView.as_view(), name='receipt-print'),
    path('receipts/<int:payment_pk>/email/', views.ReceiptEmailView.as_view(), name='receipt-email'),
]